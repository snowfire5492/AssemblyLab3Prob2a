...
# Description: LabThreeProblem2a.asm - Write a function AVA(&X, &Y, &Z, n, s, t)
...
comma:		.asciiz ", "
arrayX:		.word 0:5
arrayY:		.word 1, 2, 3, 4, 5
arrayZ:		.word -5, -4, -3, -2, -1		

				
		.text
		.globl main
		
main:		li $s0, 5		# using to store n value for easy change
		li $s1, 2		# using to store s value for easy change
		li $s2, 1		# using to store t value for easy change	
